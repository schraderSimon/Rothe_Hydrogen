...
class TimeEvolution():
    def __init__(self,WF_t0,potential_params,potential_type="lincombGauss",fieldFunc=None,h=1,T=10,epsilon=1e-2,t0=0,error_t0=0,filename="dumps/dumpfile",hlm=False,gauge="length"):
        """
        input:
